function [quat, states, Tbn, correctedDelAng, correctedDelVel]  = PredictStates( ...
    ...
    dt,Q) % time since last IMU measurement (sec)
...
persistent lastVelocity;
if isempty(lastVelocity)
    lastVelocity = [0;0;0];
end
...
% Remove sensor bias errors
 dAng = dAng - states(10:12);
 dVel = dVel - states(13:15);
% dVel = dVel;
% dAng = dAng ;
...
states(7:9) = states(7:9) + 0.5*(states(4:6) + lastVelocity)*dt;

lastVelocity = states(4:6);
